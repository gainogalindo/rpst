...
import jbpt.algo.tree.tctree.TCTree;
import jbpt.algo.tree.tctree.TCTreeNode;
import jbpt.algo.tree.tctree.TCType;
import jbpt.graph.DirectedEdge;
import jbpt.graph.MultiDirectedGraph;
import jbpt.graph.abs.AbstractTree;
import jbpt.graph.abs.IDirectedEdge;
import jbpt.graph.abs.IDirectedGraph;
 ...
 *
 * @see {DirectedGraphAlgorithm.isMultiTerminal} for checking if a graph is multi-terminal.
 *
